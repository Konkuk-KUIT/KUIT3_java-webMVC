...
import static core.constant.UserField.*;
...
public class User {
  ...
  public static User from(HttpServletRequest request) {
    return new User(
        ...
        request.getParameter(NAME.getKey()),
        request.getParameter(EMAIL.getKey()));
  }
  ...
  public String toString() {
    return "User [" + USER_ID + "=" + userId + "," + NAME + "=" + name + "," + EMAIL + "=" + email + "]";
  }
}
