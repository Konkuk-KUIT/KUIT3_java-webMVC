  ...
  <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
    ...
    <div class="col-md-3 text-end">
      <c:choose>
        ...
        <form name="/user/logout" method="post" action="/user/logout" style="float: left;">
          <button class="btn btn-outline-primary me-2">logout</button>
        </form>
          <a href="/user/update" role="button" class="btn btn-primary" >개인정보수정</a>
        </c:when>
        <c:otherwise>
          <a href="/user/login" type="button" class="btn btn-outline-primary me-2">LogIn</a>
          <a href="/user/register" type="button" class="btn btn-primary">Register</a>
        </c:otherwise>
      </c:choose>
    </div>
  </header>
