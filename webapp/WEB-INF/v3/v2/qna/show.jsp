                ...
                <article class="article">
                    ...
                    <div class="article-util">
                        <ul class="article-util-list">
                            <li>
                              <!-- 수정, 삭제 API 연결 필요 -->
                                <a class="link-modify-article" href="/v3/v2/questions/423/form">수정</a>
                            </li>
                            <li>
                              <!-- 수정, 삭제 API 연결 필요 -->
                                <form class="form-delete" action="/v3/v2/questions/423" method="POST">
                                ...
                                <article class="article" id="${answer.answerId}">
                                    ...
                                    <div class="article-util">
                                        <ul class="article-util-list">
                                            <li>
                                              <!-- 수정, 삭제 API 연결 필요 -->
                                                <a class="link-modify-article" href="/v3/v2/questions/1/answers/1/form">수정</a>
                                            </li>
                                            <li>
                                              <!-- 수정, 삭제 API 연결 필요 -->
                                                <form class="delete-answer-form" action="/v3/v2/questions/1/answers/1" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
